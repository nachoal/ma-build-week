...
| Secret scan | Current set, staged inputs, reachable history, app bundle, and compiled executable strings | `scripts/scan-secrets.sh` after the 213/213, 10/10, and 1/1 simulator gates and again inside the exact-commit archive workflow | PASS on final candidate/archive |
